<template>
  <div id="navbar" className='fixed w-full h-[80px] flex justify-between items-center px-4 text-[#233554] bg-gradient-to-b from-[#ffffff2f] to-transparent font-semibold dark:text-gray-300 animate__lightSpeedInRight z-20 duration-300'>
      <div className="w-[10%]">
